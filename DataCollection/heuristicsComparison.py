...
from DataCollection.check import check_results_directory
...
def heuristicsComparison(iterations, board):
    check_results_directory()
    heuristic_array = [
        (calculate_manhattan_distance, 'manhattan'), (calculate_euclidian_distance, 'euclidian'),
        (calculate_average_distance, 'max (euclidian and manhattan)'),
        (calculate_manhattan_distance_wall_detection, 'manhattan-wall'), (lost_game_heuristic, 'lost-game'),
        (combined_heuristic, 'combined (manhattan and lost-game)')
    ]
