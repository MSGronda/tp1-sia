...
from puzzle_game.graphs.heuristicsGraph import createHeuristicsGraph
import json

data_to_plot = {}  # Dictionary to store solution depths for each heuristic

with open("configs/heuristics-comparison-config.json", "r") as configFile:
...
for config in configurationData:
    ...
    data_to_plot[boardToSolve][heuristicTouse] = expandedNodes
